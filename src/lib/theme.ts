...
const THEME_FILE = "icon-theme.modified.json";
const BACKUP_THEME_FILE = "icon-theme.bkp.json";
const DEFAULT_THEME_FILE = "icon-theme.json";
...
// file
function writeThemeFile(data: any) {
